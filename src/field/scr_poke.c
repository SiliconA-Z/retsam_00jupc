 ...
 */
//--------------------------------------------------------------------------------------------
BOOL EvCmdTemotiPokeChkGetPos( VM_MACHINE * core )
{
	FIELDSYS_WORK* fsys = core->fsys;
	POKEMON_PARAM * poke;
	POKEPARTY * temoti;
 ...
 */
//--------------------------------------------------------------------------------------------
BOOL EvCmdEventGetTemotiPokeChkGetPos( VM_MACHINE * core )
{
	u8 i,max;
	u16 poke_no;
	POKEMON_PARAM * poke;
 ...
 */
//--------------------------------------------------------------------------------------------
BOOL EvCmdTemotiItemChk( VM_MACHINE * core )
{
	int i,max;
	POKEPARTY* temoti;
	POKEMON_PARAM * poke;
	FIELDSYS_WORK* fsys = core->fsys;
	u16	item			= VMGetWorkValue(core);
	u16* ret_wk			= VMGetWork( core );
