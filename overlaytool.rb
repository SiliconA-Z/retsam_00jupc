...
#デフォルトで読み込むファイル
default_lsf = File.read(DEFAULT_LSFFILE, encoding: "Shift_JIS")
...
File.open(OUTPUT_LSFFILE,"w:Shift_JIS"){|file|
	file.puts(default_lsf)
	file.puts("# This file is generated by overlaytool.rb\n\n")
}


# ターゲットになるソースコードの記述ファイルを１行ずつ読む
File.readlines(MAKE_PROG_FILE, :encoding => "Shift_JIS").each{ |line|
	line.chomp!
...
#			p source_name
			line_get_flag = 0
			_count = 0
			File.open(OUTPUT_LSFFILE,"a:Shift_JIS"){|file|
